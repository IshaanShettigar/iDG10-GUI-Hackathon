 ...
 */
const UTA = joint.dia.Element.define(
  "UTA",
  {
    attrs: {
      root: {
 ...
 */
const subseaPump = joint.dia.Element.define(
  "subseaPump",
  {
    attrs: {
      root: {
 ...
 */
const subseaSeparator = joint.dia.Element.define(
  "subseaSeparator",
  {
    attrs: {
      root: {
 ...
 */
const PLET = joint.dia.Element.define(
  "PLET",
  {
    attrs: {
      root: {
 ...
 */
const UTH = joint.dia.Element.define(
  "UTH",
  {
    attrs: {
      root: {
...
const FPSO = joint.dia.Element.define(
  "FPSO",
  {
    attrs: {
      ...
      yellow_projection: {
        points:
          "-calc(0.06*w) 0  -calc(0.03*w) -calc(h) calc(0.03*w) -calc(h)   calc(0.06*w) 0",
        stroke: "#000000",
        fill: "#fac905",
      },
      yellow_big_rect: {
        points:
          "calc(0.1*w) 0 calc(0.1*w) -calc(0.55*h) calc(0.75*w) -calc(0.55*h) calc(0.75*w) 0",
        stroke: "#000000",
        fill: "#fac905",
      },
      no_fill_polygon: {
        points:
          "calc(0.61*w) -calc(0.8*h) calc(0.85*w) -calc(1.70*h) calc(0.9*w) -calc(1.55*h) calc(0.67*w) -calc(0.65*h)",
        stroke: "#000000",
        fill: "none",
      },
      yellow_small_rect: {
        points:
          "calc(0.4*w) -calc(0.55*h) calc(0.4*w) -calc(0.8*h) calc(0.67*w) -calc(0.8*h) calc(0.67*w) -calc(0.55*h)",
        stroke: "#000000",
        fill: "#fac905",
      },
      vertical_black_line: {
 ...
 */
const PLEM = joint.dia.Element.define(
  "PLEM",
  {
    attrs: {
      root: {
